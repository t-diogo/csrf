...
class teste(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0 = qtgui.time_sink_f(
            1024, #size
            samp_rate, #samp_rate
        ...
        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.set_update_time(0.10)
        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.set_y_axis(-1, 1)

        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.set_y_label('Amplitude', "")

        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.enable_tags(True)
        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.set_trigger_mode(qtgui.TRIG_MODE_FREE, qtgui.TRIG_SLOPE_POS, 0.0, 0, 0, "")
        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.enable_autoscale(False)
        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.enable_grid(False)
        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.enable_axis_labels(True)
        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.enable_control_panel(False)
        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.enable_stem_plot(False)
        ...
        for i in range(1):
            if len(labels[i]) == 0:
                self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.set_line_label(i, "Data {0}".format(i))
            else:
                self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.set_line_label(i, labels[i])
            self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.set_line_width(i, widths[i])
            self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.set_line_color(i, colors[i])
            self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.set_line_style(i, styles[i])
            self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.set_line_marker(i, markers[i])
            self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.set_line_alpha(i, alphas[i])

        self._qtgui_time_sink_x_0_0_0_1_0_0_0_0_win = sip.wrapinstance(self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.qwidget(), Qt.QWidget)
        self.tab_manager_slave_ch_layout_0.addWidget(self._qtgui_time_sink_x_0_0_0_1_0_0_0_0_win)
        ...
        self.qtgui_freq_sink_x_0_1_0_0_0_0.set_fft_window_normalized(False)
        ...
        self._qtgui_freq_sink_x_0_1_0_0_0_0_win = sip.wrapinstance(self.qtgui_freq_sink_x_0_1_0_0_0_0.qwidget(), Qt.QWidget)
        self.tab_manager_slave_ch_layout_1.addWidget(self._qtgui_freq_sink_x_0_1_0_0_0_0_win)
        ...
        self.connect((self.blocks_complex_to_float_0, 0), (self.qtgui_freq_sink_x_0_1_0_0_0_0, 0))
        self.connect((self.blocks_complex_to_float_0, 0), (self.qtgui_time_sink_x_0_0_0_1_0_0_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_time_sink_x_0_0_0_1_0_0_0_0.set_samp_rate(self.samp_rate)
